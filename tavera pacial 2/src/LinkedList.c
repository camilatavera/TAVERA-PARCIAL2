...
/** \brief Itera por la linkedlist aplicando la funcion recibida como parametro a cada elemento
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion
 * \return int Retorna  puntero a la linkedList
 */
...
/** \brief Filtra los elementos de la linkedlist segun la funcion criterio recibida como parametro.
 * 	\param pList LinkedList* Puntero a la lista
 * 	\param pFunc (*pFunc) Puntero a la funcion criterio
 * 	\return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL
                                (puntero a la nueva lista) Si ok
...
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void* pElement)){
	...
	LinkedList* llFiltrada=NULL;
	void* auxElement=NULL;

	if(this!=NULL && pFunc!=NULL){
		llFiltrada=ll_newLinkedList();
		if(llFiltrada!=NULL){
			...
			for(int i=0; i<ll_len(this); i++){
				...
				if(auxElement!=NULL && ll_indexOf(llFiltrada, auxElement)==-1 && pFunc(auxElement)==0){
					ll_add(llFiltrada, auxElement);
				}
			}
		}
	}
...
/** \brief Cuenta los elementos de la linkedlist que cumplen con la funcion criterio recibida como parametro
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int (-1) Error: si el puntero a la listas o funcion es NULL
               (Contador total)
 */
