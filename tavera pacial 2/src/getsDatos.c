...
int validarString(char *pResultado, int len, char* mensaje, char* mensajeError, char* strAvalidar, int reintentos){
	 ...
	 while(reintentos>=0){
		 ...
		 if(myGets(bufferString, sizeof(bufferString))==0 && strcmp(strAvalidar, bufferString)==0){
